package com.arefbhrn.usefulcustomviews.maskededittext;
...
import com.arefbhrn.usefulcustomviews.R;
...
public class MaskedEditText extends AppCompatEditText implements TextWatcher {
	...
	public MaskedEditText(Context context, AttributeSet attrs) {
		...
		mask = attributes.getString(R.styleable.MaskedEditText_met_mask);

		allowedChars = attributes.getString(R.styleable.MaskedEditText_met_allowed_chars);
		deniedChars = attributes.getString(R.styleable.MaskedEditText_met_denied_chars);

		String representation = attributes.getString(R.styleable.MaskedEditText_met_char_representation);
		...
		keepHint = attributes.getBoolean(R.styleable.MaskedEditText_met_keep_hint, false);
